...
cApp.controller("userRegisterCtrl", [
  ...
  function ($http, $location, getFormData, shareService, $scope) {
    ...
    $scope.populate = function () {
      document.forms["register_form"]["f_name"].value = "Lehenga";
      document.forms["register_form"]["l_name"].value = "Mifh";
      document.forms["register_form"]["email"].value = "asdk@gmail.com";
      document.forms["register_form"]["pwd"].value = "skjsd";
    };
